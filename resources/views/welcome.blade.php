...
<head>
 ...
 <link rel="stylesheet" href="{{ URL::asset("webfonts/all.css") }}">
 <link rel="stylesheet" href="{{ URL::asset("css/app.css") }}">

</head>
 <script src="{{ route("welcome")}}/js/app.js"></script>
 <script src="{{ route("welcome")}}/js/alpine.js"></script>

 <body class="antialiased">
    <!-- This example requires Tailwind CSS v2.0+ -->
    <nav class="bg-white"  x-data="{ mobilemenu : false }" >
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
          <div class="relative flex items-center justify-between h-16"  >

            <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
              <!-- Mobile menu button-->
              <button type="button" @click="mobilemenu = true"  class="inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:text-white hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-inset focus:bg-purple-500 focus:ring-purple-600 focus:text-white" aria-controls="mobile-menu" aria-expanded="false">
                ...
                -->
                <svg x-show="mobilemenu === false" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                -->
                <svg x-show="mobilemenu === true" class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            ...
            <div  class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
              <div class="flex-shrink-0 flex items-center">
                <img class="block lg:hidden h-8 w-auto" src="{{ URL::asset('images/app.png') }}" alt="Workflow">
                <img class="hidden lg:block h-8 w-auto" src="{{ URL::asset('images/app.png') }}" alt="Workflow">
              </div>
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              <button class="hover:bg-purple-700 p-1 rounded-full text-gray-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-purple-600 focus:ring-white">
